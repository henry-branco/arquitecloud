...
(como fizemos [no post anterior](/posts/criando-primeiro-bucket-s3-boto3))
e ter um pipeline automatizado: aqui, o "pipeline" já vem pronto por conta
de estar conectado ao git.
